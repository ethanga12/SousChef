...
var InlineObject7 = function () {
   ...
   */
  function InlineObject7(ingredientList, servings) {
  ...
  _createClass(InlineObject7, null, [{
    key: 'initialize',
    value: function initialize(obj, ingredientList, servings) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('measure')) {
          obj['measure'] = _ApiClient2.default.convertToType(data['measure'], 'String');
        }
        if (data.hasOwnProperty('view')) {
          obj['view'] = _ApiClient2.default.convertToType(data['view'], 'String');
        }
        if (data.hasOwnProperty('defaultCss')) {
          obj['defaultCss'] = _ApiClient2.default.convertToType(data['defaultCss'], 'Boolean');
        }
        if (data.hasOwnProperty('showBacklink')) {
          obj['showBacklink'] = _ApiClient2.default.convertToType(data['showBacklink'], 'Boolean');
        }
      }
      return obj;
    }
