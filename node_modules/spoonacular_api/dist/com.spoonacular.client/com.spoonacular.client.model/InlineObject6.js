...
var InlineObject6 = function () {
   ...
   */
  function InlineObject6(ingredientList, servings) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('includeNutrition')) {
          obj['includeNutrition'] = _ApiClient2.default.convertToType(data['includeNutrition'], 'Boolean');
        }
      }
      return obj;
    }
